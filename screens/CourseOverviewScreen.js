            ...
            if (enrollmentResponse.status === 404) {
                ...
                const completionPromises = lessonsData.map(async (lesson) => {
                    try {
                        ...
                        return { lessonId: lesson._id, completed: false, status: 'not_started' };
                    } catch (error) {
                ...
                const completedCount = completionResults.filter(result => result.completed).length;
            ...
            <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
                ...
                {isEnrolled && (
                    <Card containerStyle={styles.progressCard}>
                        ...
                        <Text style={styles.progressText}>
                            {completedLessons} of {courseInfo.numLessons} lessons completed ({Math.round(progressPercentage)}%)
                        </Text>
                    </Card>
                )}
                ...
                <Card containerStyle={styles.detailsCard}>
                    ...
                    <View style={styles.detailItem}>
                        ...
                        <Text style={styles.detailText}>Estimated time: {courseInfo.numLessons * 15} minutes</Text>
                    </View>
                    <View style={styles.detailItem}>
